/// 게시글 관련 데이터 모델(post.dart)
/// 
/// Comment 클래스:
/// - 댓글 정보를 담는 데이터 클래스입니다.
/// - 댓글 ID, 작성자, 내용, 작성 시간 등을 포함합니다.
/// 
/// Post 클래스:
/// - 게시글 정보를 담는 데이터 클래스입니다.
/// - 게시글 ID, 제목, 내용, 이미지 URL, 작성자, 댓글 목록 등을 포함합니다.
/// - fromJson()으로 서버 응답을 파싱하고, toJson()으로 요청 데이터를 생성합니다.
